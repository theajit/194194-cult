...
INSERT INTO blog_posts (slug,title,excerpt,content_markdown,author_name,status,cover_kind,published_at)
VALUES (
  'what-is-194-194-cult',
  'What is 194.194 Cult?',
  'Why a community born around a café carries a number inspired by caffeine — and why 194.194 is a signature, not a chemistry claim.',
  $blog1$
...
VALUES (
  ...
  'Coffee Guide: Espresso Drinks, Decoded',
  'A practical visual guide to espresso, doppio, macchiato, ristretto, americano, latte, cappuccino, flat white, piccolo, mocha, affogato and magic.',
  $blog2$
...
**Barista note:** Add the milk gently. A small swirl can blend the centre while preserving visible layers.
