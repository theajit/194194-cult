...
export default async function PinPage({params}:{params:{pin:string}}){
  ...
  if(!d)return <main><nav><Link href="/" className="brand"><b>194.194</b><span>CULT</span></Link><Link href="/" className="back">← SEARCH ANOTHER PIN</Link></nav><section className="pinHero"><div className={`status ${status.toLowerCase()}`}><span>●</span> {label[status]}</div><div className="pinNumber">{params.pin}</div><h1>Postal data<br/><i>not available</i></h1><p>This is a valid six-digit format, but the PostgreSQL postal directory has no matching record yet.</p></section><section className="pinLayers"><article><span>POSTAL IDENTITY</span><h2>PIN CODE</h2><p>Load the official Department of Posts CSV into PostgreSQL to resolve this PIN.</p></article><article><span>PRECISE LOCATION</span><h2>DIGIPIN</h2><p>A PIN identifies a postal area. DIGIPIN identifies a precise location within that area.</p><a className="textCta" href="https://dac.indiapost.gov.in/mypincode/home" target="_blank" rel="noreferrer">FIND YOUR DIGIPIN AT INDIA POST →</a></article></section><footer><b>194.194 CULT</b><span>PIN CODE · DIGIPIN · COMMUNITY</span><span>POSTAL DATABASE</span></footer></main>;
