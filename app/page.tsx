...
export default function Home(){
  ...
  return <main>
<nav><div className="brand"><b>194.194</b><span>CULT</span></div><div className="navLinks"><a className="back" href="/blog">JOURNAL</a><a className="cafeBrand" href="https://pincode.cafe" target="_blank" rel="noreferrer"><img src="https://pincode.cafe/pin-code-cafe-logo.jpg" alt="Pin Code Café"/><span>FOUNDED AT<br/><b>PIN CODE CAFÉ</b></span></a></div></nav>
