...
<nav><div className="brand"><b>194.194</b><span>CULT</span></div><div className="navtag">BORN AT PIN CODE CAFÉ · DHENKANAL</div></nav>
<section className="hero"><div className="eyebrow">A HYPERLOCAL COMMUNITY MOVEMENT</div><h1>Does your PIN<br/>have a <i>Cult?</i></h1><p>Every PIN has an address. Some PINs have a Cult.<br/>Find yours — or be the reason it starts.</p>
...
<footer><b>194.194 CULT</b><span>NO ALGORITHM. JUST PEOPLE.</span></footer></main>}
